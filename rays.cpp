...
void CRay::finishCast(bool doSetPos){
	...
	color.r = (uint64_t)setCastColor.r*setCastColor.a*color.a/4294836225 
		+ (uint64_t)color.r*(4294836225-(uint32_t)setCastColor.a*color.a)/4294836225;
	color.g = (uint64_t)setCastColor.g*setCastColor.a*color.a/4294836225
		+ (uint64_t)color.g*(4294836225-(uint32_t)setCastColor.a*color.a)/4294836225;
	color.b = (uint64_t)setCastColor.b*setCastColor.a*color.a/4294836225
		+ (uint64_t)color.b*(4294836225-(uint32_t)setCastColor.a*color.a)/4294836225;
